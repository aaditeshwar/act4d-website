...
- Participatory information sharing systems in low-literacy environments ([video](https://www.youtube.com/watch?v=zOFZFvmXPSI), [video](https://www.youtube.com/watch?v=c9FFt_iIlqM))
- Ethics of information systems ([video](https://youtu.be/kEsj9P6i5ps))

**Office:** Room 103, Khosla School of Information Technology, IIT Delhi, New Delhi 110016
...
I started in ICTs for development believing that if people can create and share information on their own, many things can be set right. Students at IIT, the Gram Vaani team, and colleagues from Waterloo built platforms and processes toward that: rural Internet connectivity, IVR and community radio for less-literate users, and methods for content and community mobilisation. Together we have worked with over 150 organisations in India, South Africa, Tanzania, Mali, Sri Lanka, and Afghanistan; influenced ICT use in government (Municipal Corporation of Delhi, Ministry of Rural Development, Ministry of Information and Broadcasting); and drawn support from UNFPA, Ford, MacArthur, Knight, UNDP, Gates, Grand Challenges Canada, DeitY, DST, Google, and Intel India. 2G/3G measurement work was tabled before TRAI for QoS regulation.

I then saw that policy support and capital often block scale, and that exploitation, corruption, and mis-allocation make the fight against poverty harder. That led to work on open data and political economy: agricultural price anomalies, government–corporate interlocks, media bias, village-scale development, and linking macro trends with community media.
...
- 2022: ACM SIGCHI Social Impact Award
- 2021: Award for teaching excellence, IIT Delhi
- 2021: Varshney Award, Systems Society of India
- 2008: Knight News Challenge
- 2002: Ratan Swaroop Memorial Award, IIT Kanpur

**Group (Gram Vaani)**

- 2022: Agami Prize
- 2020: World Bank Mission Billion Challenge
- 2018: UNESCO Equals-in-Tech finalist
- 2016: Nasscom Social Innovation Challenge
...
- *SIL861 Ethics in Applied Computer Science (2019–20 sem 2)*: [archive](archive.html#/ethics-in-applied-cs)
- *SIL802 Data Science for Development (2016–17 sem 2)*: [archive](archive.html#/data-science-for-development)
- *COL100 (2016–17 sem 1)*: [section notes](https://www.cse.iitd.ernet.in/~aseth/col100/col100.html)
- *SIL801 Media Analysis (2015–16 sem 2)*: [archive](archive.html#/media-analysis)
- *SIL802 ICTD (2014–15 sem 2)*: [archive](archive.html#/introduction-to-ictd-long)
- *CSP301 Information Visualization (2012–13 sem 1)*: [original course page](https://www.cse.iitd.ernet.in/~aseth/)
- *CSL867 Internet Edge Optimization (2011–12 sem 2)*: [archive](archive.html#/internet-edge-optimization)
- *CSL858 Advanced Computer Networks (2010–11 sem 1)*: [archive](archive.html#/advanced-comp-networks)
...
- [Amit Ruhela](https://www.tacc.utexas.edu/about/directory/amit-ruhela). *Analysis of the Spread of Information on Twitter and its Application to Internet Content Distribution.* Graduated 2016. Research Associate, TACC, UT Austin.
- [Dipanjan Chakraborty](https://www.bits-pilani.ac.in/hyderabad/dipanjan/Profile). *Improving Citizen-Government Engagement in the Implementation of Welfare Schemes.* Graduated 2018. Assistant Professor, BITS Pilani Hyderabad.
- [Aparna Moitra](https://www.linkedin.com/in/aparna-moitra/?originalSubdomain=in), with Prof. Archna Kumar (Delhi University). *Mobile-based Community Media for Development: Jharkhand Mobile Vaani.* Graduated 2018. Post-doctoral researcher, University of Toronto.
...
**Non-fiction:** Schumacher, *Small is Beautiful*; McLuhan, *Understanding Media*; Hayek, *The Road to Serfdom*; Piketty, *Capital in the Twenty-First Century*; Diamond, *Guns, Germs, and Steel*; Postman, *Amusing Ourselves to Death*; Habermas, *The Structural Transformation of the Public Sphere*; Smillie, *Mastering the Machine*; Sainath, *Everybody Loves a Good Drought*; Drèze and Sen, *An Uncertain Glory*; Meadows, *Thinking in Systems*; C. Wright Mills, *The Power Elite*; de Soto, *The Mystery of Capital*; Kuhn, *The Structure of Scientific Revolutions*.

**Fiction (authors):** Steinbeck, Orwell, Huxley, Anthony Burgess, Harper Lee, Camus, J.D. Salinger, Kafka, Faulkner, DBC Pierre, J.M. Coetzee, Douglas Adams, Fitzgerald, Márquez, Maugham, Ian McEwan, Cormac McCarthy, Ralph Ellison, Kim Stanley Robinson.
