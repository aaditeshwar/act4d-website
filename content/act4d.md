...
*Department of Computer Science and Engineering, and Amar Nath and Shashi Khosla School of Information Technology, IIT Delhi.*

## About

Led by [Aaditeshwar Seth](aseth.html), the group works in the following areas:

- **Environment and natural resource management for community-based development** — using geospatial data, satellite imagery, and field knowledge to help rural communities plan around water, land, and forests as climate pressures grow [[video](https://www.youtube.com/watch?v=DcznjfVBruo)].
- **Analysis of factors impeding socio-economic development in rural areas** — tracking how policy, media, and political economy shape (or stall) development outcomes across Indian districts.
- **Participatory information sharing systems in low-literacy environments** — voice- and mobile-based platforms that let people with limited literacy or connectivity produce and consume local information on their own terms [[video](https://www.youtube.com/watch?v=zOFZFvmXPSI), [video](https://www.youtube.com/watch?v=c9FFt_iIlqM)].
- **Ethics of information systems** — how technology design and the management of technology platforms can either entrench or dismantle existing inequalities [[video](https://youtu.be/kEsj9P6i5ps)].

**Contact:** aseth [at] cse [dot] iitd [dot] ac [dot] in · Room 114, SIT building, IIT Delhi, New Delhi 110016

<img class="contact-photo" src="images/balazahir.jpg" alt="Aaditeshwar Seth with collaborators">
...
<img class="achievement-img--on-light" src="images/Gram%20vaani%20Logo%20Hi%20Res%20PNG.png" alt="Gram Vaani logo">
<p><strong><a href="https://gramvaani.org/">Gram Vaani</a></strong> (co-founded, 2009) — A social enterprise running voice-based community media platforms (Mobile Vaani) across rural India, giving low-literacy, low-connectivity communities a platform to share information, hold institutions accountable, and organize collectively. In partnership with over 200 civil society organizations, 4M+ users have directly interacted with Gram Vaani platforms.</p>
</div>
...
<img src="images/act-logo.png" alt="Cover of Technology and (Dis)Empowerment: A Call to Technologists">
<p><em><strong><a href="act.html">Technology and (Dis)Empowerment: A Call to Technologists</a></strong></em> (Emerald Publishing, 2022) — A book distilling over a decade and half of work on the relationship between technology, political economy, and social development, arguing that technology's design and management should aim explicitly at bringing power-based equality rather than efficiency or profit alone.</p>
</div>
...
**[Technology as a tool to overturn unjust structures](act.html)** — the goal of technologists should be to overturn unjust societal structures to empower the weak and oppressed. This means: setting clear ends alongside means; building explicitly toward power-based equality; embedding ethics into both the design *and* the ongoing management of a technology; and ensuring the people a technology is meant to serve are actually involved in designing and managing it. Read this [note](https://www.cse.iitd.ernet.in/~aseth/research-at-act4d.pdf) which describes the passion and ideals that drive our work, 
...
We are actively hiring to build CoRE Stack — an extremely ambitious and impactful digital public infrastructure for climate change adaptation for rural communities. Open to:

- PhD, Masters, and Bachelor's students
- Research assistants
- Post-doctoral fellows
- Software engineers (0–8 years of experience)

Short-term (under 6 months) and remote internships are not currently supported. Prospective students and collaborators can look through the [list of ongoing projects](ongoing-projects-24-25.html) and [PhD topics](phd-topics-24-25.html) — spanning forest and biodiversity monitoring, water security, agriculture, impact assessment, and land monitoring — to get a sense of the work and the skills it draws on, and are encouraged to read the [research philosophy note](https://www.cse.iitd.ernet.in/~aseth/research-at-act4d.pdf) before reaching out. Software engineering roles are periodically posted on the [CoRE Stack site](https://core-stack.org/openings-software-engineer-geospatial-technologies/); interested candidates with a strong computer science background or domain knowledge with strong computing experience can email a CV directly to **aseth [at] cse [dot] iitd [dot] ac [dot] in**.
...
**Research associates over the years:** [Aman Khullar](https://amankhullar.github.io/), [Aravindh Raman](https://aravindhr.am/), [Raman Kumar](https://ramank1137.github.io/), Shubham Kumar, Apoorva Kashyap, Asheesh Sharma, Atharv Dabhi

**Post-doctoral fellows who have worked with the group:** [Ramneek Kaur](https://in.linkedin.com/in/kramneek), [Yayati Gupta](https://www.mahindrauniversity.edu.in/faculty/dr-yayati-gupta/)
...
**Infrastructure leads:** Saharsh Laud, Saurabh Joshi, Ritik Kushwaha
...
<img class="figure-wide" src="images/kiosknet.png" alt="KioskNet: community use, rural kiosk, rooftop installation, and hardware">
...
<img class="figure-wide" src="images/grins.png" alt="GRINS community radio studio, telephony, and system diagrams">
